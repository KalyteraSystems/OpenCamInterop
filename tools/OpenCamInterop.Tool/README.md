...
```text
dotnet run --project OpenCamInterop/tools/OpenCamInterop.Tool -- inspect --adapter frigate --input OpenCamInterop/fixtures/v1/frigate/object-new.json --source urn:opencaminterop:local:inspect
dotnet run --project OpenCamInterop/tools/OpenCamInterop.Tool -- verify --manifest OpenCamInterop/fixtures/v1/manifest.json
dotnet run --project OpenCamInterop/tools/OpenCamInterop.Tool -- replay --manifest OpenCamInterop/fixtures/v1/manifest.json --no-wait
```
...
```text
dotnet run --project OpenCamInterop/tools/OpenCamInterop.Tool -- verify --manifest OpenCamInterop/fixtures/v1/manifest.json --print-matrix
```
