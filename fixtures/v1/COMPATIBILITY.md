...
| `scrypted.objects-detected.observed` | `scrypted` | [`scrypted/objects-detected.json`](scrypted/objects-detected.json) | event `com.kalyterasystems.opencaminterop.object.observed.v1` | Synthetic tracked ObjectsDetected observation; recognized labels, embeddings, geometry, media references, generator identity, and retention ids are deliberately fake and omitted from normalized output. |
